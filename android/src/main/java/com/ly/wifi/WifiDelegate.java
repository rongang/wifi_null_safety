...
WifiDelegate implements PluginRegistry.RequestPermissionsResultListener {
    ...
    private static final int REQUEST_ACCESS_FINE_LOCATION_PERMISSION = 11;
    private static final int REQUEST_CHANGE_WIFI_STATE_PERMISSION = 22;
        ...
        if (wifiManager != null) {
            ...
            for (ScanResult scanResult : scanResultList) {
                ...
                if (key.isEmpty()) {
                    ...
                    maps.put("is5GHz", is5GHz(scanResult.frequency));
